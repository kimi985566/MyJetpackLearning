package cn.yangchengyu.libnavcompiler;
...
/**
 * Desc  : APP页面导航信息收集注解处理器
 * Author: Chengyu Yang
 * Date  : 2020/3/6
 */
@AutoService(Processor.class)
@SupportedSourceVersion(SourceVersion.RELEASE_8)
@SupportedAnnotationTypes({"cn.yangchengyu.libnavannotation.ActivityDestination", "cn.yangchengyu.libnavannotation.FragmentDestination"})
public class NavProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        boolean isFragmentElementsEmpty = fragmentElements == null || fragmentElements.isEmpty();
        boolean isActivityElementsEmpty = activityElements == null || activityElements.isEmpty();

        if (!isActivityElementsEmpty || !isFragmentElementsEmpty) {
            HashMap<String, JSONObject> destMap = new HashMap<>(16);
