...
public abstract class Request<T, R extends Request> implements Cloneable {
    ...
    private Call getCall() {
        ...
        Call call = ApiService.OKHTTP_CLIENT.newCall(request);
        return call;
    }
    ...
    public void execute(final JsonCallback callback) {
        if (mCacheStrategy != NET_ONLY) {
            ArchTaskExecutor.getIOThreadExecutor().execute(() -> {
                ...
                if (callback != null && response.getBody() != null) {
    ...
    private ApiResponse<T> readCache() {
        ...
        result.setMessage("缓存获取成功");
        result.setBody((T) cache);
    ...
    private ApiResponse<T> parseResponse(Response response, JsonCallback<T> callback) {
        ...
        try {
            ...
            if (success) {
                if (callback != null) {
                    ...
                    result.setBody((T) convert.convert(content, argument));
                } else if (mType != null) {
                    result.setBody((T) convert.convert(content, mType));
                } else {
        ...
        if (mCacheStrategy != NET_ONLY && result.isSuccess() && result.getBody() instanceof Serializable) {
            saveCache(result.getBody());
        }
        return result;
    }
